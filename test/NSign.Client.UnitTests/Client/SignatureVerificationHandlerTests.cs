...
namespace NSign.Client
{
    public sealed class SignatureVerificationHandlerTests
    {
        ...
        public SignatureVerificationHandlerTests()
        {
            ...
            options.AlgorithmRequired = options.CreatedRequired = options.ExpiresRequired = options.KeyIdRequired =
                options.NonceRequired = false;

            request.Headers.Add("my-header", "blah");
            request.Headers.Add("my-generic-dict", "a=b, b=c");
            response.Headers.Add("my-header", "blotz");
            response.Headers.Add("my-generic-dict", "b=a, c=b");
        ...
        public async Task SignatureMismatchCausesSignatureVerificationFailedException(string signature, string signatureInput)
        {
            ...
            mockVerifier
                ...
                .ReturnsAsync((SignatureParamsComponent sigParams, byte[] input, byte[] expectedSig, CancellationToken cancel) =>
                {
